...
fig.suptitle('PC Explained Variance - features : '+str(params), fontsize=16)
...
#fig.suptitle('PCA - features : '+str(params), fontsize=16)
...
ax.scatter(res_pca[:,0], res_pca[:,1], s=400)
...
fig.savefig('results/pca_1_rank.png')
